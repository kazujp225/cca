      ...
      <div className="bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
        <div className="flex items-center justify-between">
          ...
          >
            ...
            <option value="date">最近の活動順</option>
          </select>
        </div>
      </div>
    </div>
                ...
                <label className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-orange-700 dark:text-orange-300">
                      --dangerously-skip-permissionsフラグと同等
                    </div>
                  </div>
                </label>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                ...
                >
                  ...
                  <span className="sm:hidden">ツールを追加</span>
                </Button>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                <Input
                  ...
                  placeholder='例: "Bash(rm:*)" または "Write"'
                  onKeyPress={(e) => {
                    if (e.key === 'Enter') {
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
              ...
              <ul className="text-sm text-blue-800 dark:text-blue-200 space-y-1">
                <li><code className="bg-blue-100 dark:bg-blue-800 px-1 rounded">"Bash(git log:*)"</code> - 全てのgit logコマンドを許可</li>
                <li><code className="bg-blue-100 dark:bg-blue-800 px-1 rounded">"Bash(git diff:*)"</code> - 全てのgit diffコマンドを許可</li>
                <li><code className="bg-blue-100 dark:bg-blue-800 px-1 rounded">"Write"</code> - 全てのWriteツールの使用を許可</li>
                <li><code className="bg-blue-100 dark:bg-blue-800 px-1 rounded">"Read"</code> - 全てのReadツールの使用を許可</li>
                <li><code className="bg-blue-100 dark:bg-blue-800 px-1 rounded">"Bash(rm:*)"</code> - 全てのrmコマンドをブロック（危険）</li>
              </ul>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <p className="text-sm text-muted-foreground">
                  Model Context ProtocolサーバーはClaudeに追加のツールとデータソースを提供します
                </p>
              </div>
              ...
              <div className="fixed inset-0 bg-black/50 flex items-center justify-center z-[110] p-4">
                <div className="bg-background border border-border rounded-lg w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                  <div className="flex items-center justify-between p-4 border-b border-border">
                    <h3 className="text-lg font-medium text-foreground">
                      {editingMcpServer ? 'MCPサーバーを編集' : 'MCPサーバーを追加'}
                    </h3>
                  ...
                  <form onSubmit={handleMcpSubmit} className="p-4 space-y-4">
                    ...
                    <div className="border-t border-gray-200 dark:border-gray-700 pt-4">
                      <div className="flex items-center justify-between mb-3">
                        <h4 className="font-medium text-foreground">設定テスト</h4>
                        <Button
                          type="button"
                    ...
                    <div className="flex justify-end gap-2 pt-4">
                      ...
                      >
                        {mcpLoading ? '保存中...' : (editingMcpServer ? 'サーバーを更新' : 'サーバーを追加')}
                      </Button>
                    </div>
                  </form>
                </div>
